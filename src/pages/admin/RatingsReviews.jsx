...
const RatingsReviews = () => {
    ...
    try {
      ...
      let url =
        filter === "most" //most rated
          ? `${import.meta.env.VITE_SERVER_URL}/api/package/get-packages?searchTerm=${search}&sort=packageTotalRatings`
          : `${import.meta.env.VITE_SERVER_URL}/api/package/get-packages?searchTerm=${search}&sort=packageRating`; //all
  ...
  const onShowMoreSClick = async () => {
    ...
    let url =
      filter === "most" //most rated
        ? `${import.meta.env.VITE_SERVER_URL}/api/package/get-packages?searchTerm=${search}&sort=packageTotalRatings&startIndex=${startIndex}`
        : `${import.meta.env.VITE_SERVER_URL}/api/package/get-packages?searchTerm=${search}&sort=packageRating&startIndex=${startIndex}`; //all
    const res = await fetch(url);
    const data = await res.json();
