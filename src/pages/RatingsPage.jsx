  ...
  const getRatings = async () => {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_SERVER_URL}/api/rating/get-ratings/${params.id}/999999999999`
      );
      const res2 = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/rating/average-rating/${params.id}`);
